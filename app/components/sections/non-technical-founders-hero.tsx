...
export function NonTechnicalFoundersHero() {
  return (
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          >
            ...
            <h1 className="font-display text-4xl sm:text-5xl md:text-6xl lg:text-7xl font-bold leading-[1.15] mb-8">
              ...
              <span className="text-pink-500">Non-Technical Founders</span>
            </h1>

            {/* Subheading */}
            <p className="text-lg sm:text-xl text-foreground/80 max-w-xl mx-auto lg:mx-0 mb-8">
              Add a chat widget with one script tag. Visitor messages appear in Discord or Slack. Reply from there - they see it on your site instantly. No coding required.
            </p>

            {/* CTAs */}
            <div className="flex flex-col sm:flex-row gap-4 justify-center lg:justify-start">
              <Button variant="gradient" size="xl" className="group" asChild>
                <a href="/go?ref=non-technical-founders">
          ...
          {/* Right Column - Simple Setup Mockup */}
          <motion.div
            ...
            <Float delay={0} y={8}>
              <div className="relative bg-white rounded-2xl border-2 border-outline shadow-[8px_8px_0_#1a1a1a] p-4 mx-auto max-w-md lg:max-w-none">
                ...
                <div className="flex items-center gap-2 mb-3 pb-3 border-b border-border">
                  ...
                  <Badge variant="success" size="sm">2 steps</Badge>
                </div>
                ...
                <div className="space-y-4">
                  ...
                  <div className="space-y-2">
                    <div className="flex items-center gap-2">
                      <div className="w-6 h-6 bg-pink-500 rounded-full border-2 border-outline flex items-center justify-center flex-shrink-0">
                        <span className="text-white text-xs font-bold">1</span>
                      </div>
                      <span className="text-xs font-semibold text-foreground">Copy this code snippet</span>
                    </div>
                    <div className="bg-[#1e1e1e] rounded-lg p-3 border-2 border-outline">
                      <pre className="text-[9px] text-green-400 font-mono leading-relaxed overflow-x-auto">
{`<script>
  window.donkeyConfig = {
    apiKey: "dk_..."
  };
                  ...
                  <div className="space-y-2">
                    <div className="flex items-center gap-2">
                      <div className="w-6 h-6 bg-yellow-300 rounded-full border-2 border-outline flex items-center justify-center flex-shrink-0">
                        <span className="text-foreground text-xs font-bold">2</span>
                      </div>
                      <span className="text-xs font-semibold text-foreground">Paste before &lt;/body&gt;</span>
                    </div>
                    <div className="p-3 bg-yellow-50 rounded-lg border-2 border-outline">
                      <div className="flex items-start gap-2">
                        <Badge variant="success" size="sm" className="text-[9px] flex-shrink-0">✓</Badge>
                        <p className="text-[10px] text-foreground/80">
                          That's it! Your support widget is now live and ready to receive messages.
                        </p>
                      </div>
                    </div>
                  </div>
